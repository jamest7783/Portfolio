...
const Projects=({setViewProjects})=>{
    ...
    const projects=[
        ...
        {title:'AlienInvasion',movie:alienVideo,stack:['nodejs','css','html'],tech:['Vanilla JS','HTML','CSS'],deployedURL:'http://space-serpents.surge.sh/',githubURL:'https://github.com/jamest7783/Alien-Invasion-',description:'A simple, yet functionally sound game with epic styling. Built with Vanilla JavaScript, HTML, & CSS. A not-so-typical snake game featuring a Synthwave theme, an increasingly fast snake, planet power-ups, and randomly generating black-holes. Look out!'},
        {title:'CoffeeLink',movie:kohiVideo,stack:['nodejs','react','express','mongo'],tech:['JavaScript','PostGreSQL','JWT-Auth','HTML','CSS'],deployedURL:'https://protected-escarpment-45651.herokuapp.com/',githubURL:'https://github.com/jamest7783/CoffeeMarketPlaceFrontEnd/tree/main',description:"Using PostgreSQL, Express, React, Node.js my team of three built a simple yet effective e-commerce store for coffee-lovers and sellers alike. With JWT authentication, sellers are able to create, update, and delete products."}
    ]
