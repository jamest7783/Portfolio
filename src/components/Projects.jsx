            ...
            <div className='project-view' id={projects[projectIndex].title}>
                <div id='title'> 
                    ...
                    <div id='project-links'>
                        <button className='project-link'>Deployed</button>
