import Office from "./subcomponents/Office"
...
const StoryBoard=()=>{
    ...
    return(
        <div id='story-board'>
            ...
            <div className='house' id='elevator'></div>
            <div className='house' id='balcony-rail'></div>
            ...
            <div className='house' id='elevator-shaft-0'></div>
            ...
            <div className='frame' id='frame-4'></div>
            <div id='framed-pic-1'></div>
